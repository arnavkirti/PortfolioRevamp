export default function SocialLinks() {
    return <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
        {/* Twitter/X */}
        <a
            href="https://x.com/ArnavKirti"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center p-4 bg-zinc-900/50 border border-zinc-800/50 rounded-lg hover:bg-zinc-800/50 hover:border-zinc-700/50 transition-all duration-300 group"
        >
        ...
        {/* Email */}
        <a
            href="mailto:arnavk.tkd@gmail.com"
            className="flex items-center justify-center p-4 bg-zinc-900/50 border border-zinc-800/50 rounded-lg hover:bg-zinc-800/50 hover:border-zinc-700/50 transition-all duration-300 group"
        >
