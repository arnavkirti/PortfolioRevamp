...
import { LabProjectProps, statusConfig, complexityConfig } from "@/utils/labs";
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${
              ...
              complexity === 'medium' ? 'bg-yellow-500/20 text-yellow-400' :
        ...
        <div className="flex items-center gap-3">
          ...
          {githubUrl && (
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-gray-400 border border-gray-600/30 rounded-md hover:bg-gray-600/10 hover:text-gray-300 transition-all duration-200"
            >
