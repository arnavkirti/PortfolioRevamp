export default function Solidity() {
    return (
        <div className="w-10 h-10 bg-zinc-950 flex items-center justify-center hover:bg-zinc-800 transition-colors">
            <svg className="w-6 h-6 text-blue-400" viewBox="0 0 128 128" fill="currentColor">
